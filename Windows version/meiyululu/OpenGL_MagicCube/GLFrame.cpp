...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	if (appl != 0)
	{
		ret = appl->Main(hInstance, hPrevInstance, lpCmdLine, "魔方--OPENGL版", nCmdShow);/**< 执行程序主循环 */
...
/** 程序的主循环 */
int GLApplication::Main(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, const char *WindowText, int nCmdShow)
{
	/// 注册一个窗口
	...
	windowClass.hIcon			= LoadIcon(hInstance, (LPCTSTR)IDI_ICON1);
	...
	{																	
		/// 创建一个窗口
		if (m_Window.Create(WindowText, m_ClassName,m_CreateFullScreen, hInstance, this) == true)
		{	

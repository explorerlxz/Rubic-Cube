...
public:
	...
	void setPivotPoint(Vector3* _pivot) {pivot[0] = _pivot->x; pivot[1] = _pivot->y; pivot[2] = _pivot->z;}
	void getPivotPoint(Vector3* _pivot) {_pivot->x = pivot[0]; _pivot->y = pivot[1]; _pivot->z = pivot[2];}
